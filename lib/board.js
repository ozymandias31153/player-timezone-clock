const { formatBoardTime, formatIsoForFooter } = require("./time");
...
const ZONE_LIBRARY = [
  ...
  { id: "auckland", label: "Auckland", tz: "Pacific/Auckland", defaultEnabled: true, order: 5 },
  { id: "france", label: "France", tz: "Europe/Paris", defaultEnabled: true, order: 6 },
  { id: "shanghai", label: "Shanghai", tz: "Asia/Shanghai", defaultEnabled: true, order: 7 },
  { id: "bulgaria", label: "Bulgaria", tz: "Europe/Sofia", defaultEnabled: false, order: 8 }
];
